...
interface TicketRepository extends JpaRepository<TicketEntity, Long> {
    ...
    void updateOrderedTicketNumber(@NonNull UUID eventId, @NonNull Integer amount, @Nullable String category);
    ...
    void updateReservedTicketNumber(@NonNull UUID eventId, @NonNull Integer amount, @Nullable String category);
}
